...
- 곡은 자동으로 나오지 않는다. **Songs 화면에서 새 곡 작업을 예약해야** 다음 합주 한 칸이 데모를 만든다. 예약하지 않은 합주는 기존 곡의 공연 준비와 멤버 성장에 쓰이고, 준비할 곡은 무대에 올릴 대표곡을 따라가되 직접 고를 수도 있다.
- **녹음**은 데모를 발매할 수 있는 음원으로 만든다. 녹음실과 대상 곡이 필요하고 주당 한 칸까지다. 녹음하지 않은 곡은 공연에는 쓸 수 있지만 발매할 수 없다.
- 곡의 4축(대중성/음악성/팬 적합/라이브)은 멤버 능력·Music DNA·컨디션·제작 맥락에서 계산된다. 첫 공연 이후 싱글·EP 발매가 열리고 음원 수익이 매주 들어온다.
- 공연은 주간 일정 한 칸을 쓰는 활동이다. 제안 수락 → 일정에 공연 배치 → 무대 → 결과 확정이 하나로 이어지고, 제작비·피로·멤버 경험치·수익·팬·평판은 실제로 무대에 올랐을 때 한 번만 적용된다. 예약만 해 두고 무대에 오르지 않으면 아무것도 청구되지 않는다.
